...
//! mutation primitives IME/input operations build on. Editing always
//! invalidates the touched line's wrap cache at the single mutation point
//! (`Line::content_mut`) — this module's half of replacing `TextLineModel`'s
//! content-snapshot cache-validity check.
