...
class CaretGeometryLayoutTest {
    ...
    private val ltr = ResolvedTextDirection.Ltr
    private val rtl = ResolvedTextDirection.Rtl

    @Test
    fun ltrTrailingSpaceStepsByExactlyOneCharWidth() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
    ...
    @Test
    fun rtlTrailingSpaceStepsByExactlyOneCharWidth() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "مرحبا "
    ...
    @Test
    fun multiBlankTrailingBackspaceStepsOneBlankAtATime() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "hello   "
    ...
    @Test
    fun trailingBlankAfterPunctuationStepsByItsOwnWidth() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "hello. "
    ...
    @Test
    fun surrogatePairBeforeTrailingSpaceIsNotGlued() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "\uD83D\uDE00 "
    ...
    @Test
    fun midLineBlankRunKeepsPlatformPlacement() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "a   b"
    ...
    @Test
    fun leadingBlankRunKeepsPlatformPlacement() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        val text = "  x"
    ...
    @Test
    fun wrappedTrailingBlankStillStepsOneBlankWidth() = runComposeUiTest {
        lateinit var tm: TextMeasurer
        setContent { tm = rememberTextMeasurer() }
        val style = TextStyle.Default
        ...
        val layout = tm.measure(text, style, constraints = Constraints(maxWidth = wrapWidth))
